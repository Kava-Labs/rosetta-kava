...
func (_m *Client) EstimateGas(_a0 context.Context, _a1 types.Tx, _a2 float64) (uint64, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 uint64
	if rf, ok := ret.Get(0).(func(context.Context, types.Tx, float64) uint64); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(uint64)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, types.Tx, float64) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}

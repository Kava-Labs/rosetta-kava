...
func (_m *Client) Account(_a0 context.Context, _a1 types.AccAddress) (authtypes.AccountI, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AccAddress) (authtypes.AccountI, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *Client) Balance(_a0 context.Context, _a1 *rosetta_sdk_gotypes.AccountIdentifier, _a2 *rosetta_sdk_gotypes.PartialBlockIdentifier, _a3 []*rosetta_sdk_gotypes.Currency) (*rosetta_sdk_gotypes.AccountBalanceResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *rosetta_sdk_gotypes.AccountIdentifier, *rosetta_sdk_gotypes.PartialBlockIdentifier, []*rosetta_sdk_gotypes.Currency) (*rosetta_sdk_gotypes.AccountBalanceResponse, error)); ok {
...
func (_m *Client) Block(_a0 context.Context, _a1 *rosetta_sdk_gotypes.PartialBlockIdentifier) (*rosetta_sdk_gotypes.BlockResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *rosetta_sdk_gotypes.PartialBlockIdentifier) (*rosetta_sdk_gotypes.BlockResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *Client) EstimateGas(_a0 context.Context, _a1 signing.Tx, _a2 float64) (uint64, error) {
	...
	var r0 uint64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, signing.Tx, float64) (uint64, error)); ok {
...
func (_m *Client) PostTx(ctx context.Context, txBytes []byte) (*rosetta_sdk_gotypes.TransactionIdentifier, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostTx")
	}

	var r0 *rosetta_sdk_gotypes.TransactionIdentifier
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []byte) (*rosetta_sdk_gotypes.TransactionIdentifier, error)); ok {
...
func (_m *Client) Status(_a0 context.Context) (*rosetta_sdk_gotypes.BlockIdentifier, int64, *rosetta_sdk_gotypes.BlockIdentifier, *rosetta_sdk_gotypes.SyncStatus, []*rosetta_sdk_gotypes.Peer, error) {
	...
	var r5 error
	if rf, ok := ret.Get(0).(func(context.Context) (*rosetta_sdk_gotypes.BlockIdentifier, int64, *rosetta_sdk_gotypes.BlockIdentifier, *rosetta_sdk_gotypes.SyncStatus, []*rosetta_sdk_gotypes.Peer, error)); ok {
		return rf(_a0)
	}

...
func (_m *RPCClient) Account(ctx context.Context, addr types.AccAddress, height int64) (authtypes.AccountI, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AccAddress, int64) (authtypes.AccountI, error)); ok {
		return rf(ctx, addr, height)
	}
...
func (_m *RPCClient) Balance(ctx context.Context, addr types.AccAddress, height int64) (types.Coins, error) {
	...
	var r0 types.Coins
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AccAddress, int64) (types.Coins, error)); ok {
		return rf(ctx, addr, height)
	}
...
func (_m *RPCClient) BroadcastEvidence(_a0 context.Context, _a1 cometbfttypes.Evidence) (*coretypes.ResultBroadcastEvidence, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Evidence) (*coretypes.ResultBroadcastEvidence, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Evidence) *coretypes.ResultBroadcastEvidence); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, cometbfttypes.Evidence) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RPCClient) BroadcastTxAsync(_a0 context.Context, _a1 cometbfttypes.Tx) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) (*coretypes.ResultBroadcastTx, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) *coretypes.ResultBroadcastTx); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, cometbfttypes.Tx) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RPCClient) BroadcastTxCommit(_a0 context.Context, _a1 cometbfttypes.Tx) (*coretypes.ResultBroadcastTxCommit, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) (*coretypes.ResultBroadcastTxCommit, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) *coretypes.ResultBroadcastTxCommit); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *RPCClient) BroadcastTxSync(_a0 context.Context, _a1 cometbfttypes.Tx) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *RPCClient) CheckTx(_a0 context.Context, _a1 cometbfttypes.Tx) (*coretypes.ResultCheckTx, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) (*coretypes.ResultCheckTx, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, cometbfttypes.Tx) *coretypes.ResultCheckTx); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *RPCClient) Delegations(ctx context.Context, addr types.AccAddress, height int64) (stakingtypes.DelegationResponses, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for Delegations")
	}

	var r0 stakingtypes.DelegationResponses
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AccAddress, int64) (stakingtypes.DelegationResponses, error)); ok {
		return rf(ctx, addr, height)
	}
...
func (_m *RPCClient) SimulateTx(ctx context.Context, tx signing.Tx) (*types.SimulationResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, signing.Tx) (*types.SimulationResponse, error)); ok {
		return rf(ctx, tx)
	}
...
func (_m *RPCClient) UnbondingDelegations(ctx context.Context, addr types.AccAddress, height int64) (stakingtypes.UnbondingDelegations, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for UnbondingDelegations")
	}

	var r0 stakingtypes.UnbondingDelegations
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AccAddress, int64) (stakingtypes.UnbondingDelegations, error)); ok {
		return rf(ctx, addr, height)
	}
